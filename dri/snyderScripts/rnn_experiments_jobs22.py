                                                        ...
                                                        for gpu in gpus: 
                                                            for trial in trials:
                                                                for fold in selectFolds:
                                                                    submitStr="qsub -q "+queue+" -v nettype='" + str(nettype)+"',mem='" +str(mem)+"',prtype='" + prtype + "',singlepr='"+str(singlepr) + "',test='"+str(test) + "',bias='" + bias + "',deg='" + str(deg) + "',limit='" +str(limit)+ "',summ='"+str(summ)+"',weight='"+str(weight)+ "',nodeg='" +str(deg0) + "',aug='" + str(aug) + "',rinit='" +str(rinit) + "',usepr='" + str(usepr)  + "',gpu='" + str(gpu) +  "',trial='"+str(trial)+"',fold='"+str(fold)+  "' rnn_exp32"+PostFix+".sub"
                                                                    print(submitStr)
                                                                    os.system(submitStr)
